...
// 2. Dynamic Blogger JSONP Live Posts Renderer (Zero-CORS Bypassing)
...
function loadBloggerPosts() {
  ...
  script.src = 'https://bhushannd1234.blogspot.com/feeds/posts/default?alt=json-in-script&callback=handleBloggerPosts';
...
function initPortfolioApp() {
  ...
  // Load Dynamic Blogger Posts via JSONP
  loadBloggerPosts();
}
